...
function fillPage2(page, font, data) {
  ...
  const SEC7_CELLS = {
    born: [368.6, 241.3, 391.6],
    age1to2: [279.8, 253.2, 302.8],
    age3: [78.2, 263.8, 101.2],
    age4to5: [43.6, 242.3, 67.0],
    age6to17: [39.6, 252.2, 63.0],
    age18: [324.1, 263.8, 347.1],
  }
  const SEC8_CELLS = {
    born: [368.6, 288.9, 391.6],
    age1to2: [279.8, 300.8, 302.8],
    age3: [78.2, 311.4, 101.2],
    age4to5: [43.6, 289.9, 67.0],
    age6to17: [39.6, 299.8, 63.0],
    age18: [324.1, 311.4, 347.1],
  }
